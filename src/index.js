...
const FlatList = ({
    ...
    let listeners = useRef(global.discovery_solutions_flatlist_on_scroll_listeners).current;
    ...
    useEffect(() => {
        let updatedListeners = global.discovery_solutions_flatlist_on_scroll_listeners;
